::namespace eval ::pct::build {
  ...
  proc callback {args} {
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/home/systemc_2/final_proj/CODE/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
